...
function pickerDateRange(inputId, options) {
    ...
    var wrapper = {
        ta: [
            ...
            '<input type="text" class="ta_ipt_text_s dataClear" name="' + this.startDateId + '" id="' + this.startDateId + '" value="' + this.mOpts.startDate + '" readonly />',
            '<span class="' + this.mOpts.joinLineId + '"> - </span>',
            '<input type="text" class="ta_ipt_text_s dataClear" name="' + this.endDateId + '" id="' + this.endDateId + '" value="' + this.mOpts.endDate + '" readonly /><br />',
            '</div>',
            ...
            '</div>',
            '<div class="frm_btn">',
             '<div id="' + this.mOpts.aRecent7Days + '" class="quickbtn">近一周</div><div id="' + this.mOpts.aRecent14Days + '" class="quickbtn">近两周</div><div id="' + this.mOpts.aRecent30Days + '" class="quickbtn">近一月</div>',
            '</div>',
            '<div class="frm_btn">',
            '<input class="ta_btn ta_btn_primary" type="button" name="' + this.submitBtn + '" id="' + this.submitBtn + '" value="确定" />',
            '<input class="ta_btn rml10 cancleBtn" type="button" id="' + this.closeBtn + '" value="取消"/>',
            '</div>',
            '</div>',
            '</div>'
        ],
...
//    $("#" + this.calendarId).css('top', pos.top + (__method.mOpts.theme == 'ta' ? 35 : 22) + 'px');
    $("#" + this.calendarId).css('left', 0);
    //$("#" + this.calendarId).css('top', pos.top + (offsetHeight ? offsetHeight- 1 : (__method.mOpts.theme=='ta'?35:22)) + 'px');
    $("#" + this.calendarId).css('top', 0);
...
pickerDateRange.prototype.close = function (btnSubmit) {
    ...
    if (btnSubmit) {
        ...
        if (input && input.tagName == 'INPUT') {
            ...
            //判断不是input的情况，要不要显示日期 by haorooms博客
            if(!$('#' + this.inputId).data("noshow")){
